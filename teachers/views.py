# Bu dosya, öğretmenlerle (teacher) ilgili view (görünüm) fonksiyonlarını tanımlar.
# Öğretmen listeleme, detay görüntüleme, kayıt, düzenleme ve silme işlemlerinin iş mantığını içerir.
