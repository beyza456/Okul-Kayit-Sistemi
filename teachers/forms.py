# Bu dosya, öğretmenlerle (teacher) ilgili form alanlarını tanımlar.
# CreateTeacher formu, öğretmen kayıt ve düzenleme işlemlerinde kullanılan ModelForm'dur ve form alanlarının arayüzde nasıl görüneceğini özelleştirir.
