# Bu dosya, öğretmenlerle (teacher) ilgili URL yönlendirmelerini tanımlar.
# Öğretmen listeleme, detay görüntüleme, kayıt, düzenleme ve silme işlemlerine ait view fonksiyonlarına erişim yolları burada belirlenir.
