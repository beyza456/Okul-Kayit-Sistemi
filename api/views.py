# Bu dosya, Django Rest Framework ile API endpoint'lerinin iş mantığını (view) tanımlar.
# Öğrenci yoklama (attendance), sınav sonucu sorgulama ve yeni öğrenci kaydı işlemlerini yönetir.
# Gelen istekleri alır, doğrular, ilgili model ve serializer ile işleyip uygun JSON yanıtı döner.
