/**
 * Bu dosya, JSON verilerini web arayüzünde okunabilir ve katlanabilir (collapsible) şekilde gösteren bir jQuery eklentisidir.
 * Özellikle API yanıtlarının veya karmaşık JSON yapıların kullanıcıya kolayca incelenebilmesi için kullanılır.
 * Projede, API dökümantasyonunda veya veri görüntüleme alanlarında JSON çıktısını görsel olarak sunmak için kullanılır.
 */
