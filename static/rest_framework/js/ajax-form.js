/* Bu dosya, formların AJAX ile gönderilmesini ve sunucudan dönen HTML’in dinamik olarak sayfada gösterilmesini sağlar.
Kullanıcı deneyimini artırır, sayfa yenilemeden form işlemlerini tamamlar ve gerektiğinde sayfa yönlendirmesi yapar.
Özellikle Django Rest Framework’teki formlar için kullanılır. */


// Sunucudan dönen HTML içeriğini mevcut belge ile değiştirir.
...
// Bu fonksiyon, formun AJAX ile gönderilmesini sağlar.
// Formun methodunu ve içeriğini kontrol eder, uygun şekilde AJAX isteği yapar.
// Eğer formun methodu GET ise, standart form gönderimi kullanılır.
// Eğer POST ise, içeriğin türüne göre AJAX isteği yapılır.
...
//Hangi butonun formu gönderdiğini yakalar.
...
// Bu fonksiyon, formun AJAX ile gönderilmesini sağlar.
// Formun submit olayını dinler ve AJAX isteği yapar.
