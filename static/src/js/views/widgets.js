/*
  Bu dosya, yönetim paneli veya dashboard ekranlarında Chart.js kullanarak çeşitli kart ve widget grafiklerinin oluşturulmasını sağlar.
  Farklı renk ve tipte (çizgi, bar) grafikler için örnek veri ve yapı sunar.
  Projede, kullanıcıya istatistiksel verileri ve raporları görsel olarak sunmak, paneldeki widget'ları dinamik ve etkileşimli hale getirmek için kullanılır.
*/
