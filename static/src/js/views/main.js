/*
  Bu dosya, yönetim panelinde veya dashboard ekranlarında Chart.js ile çeşitli grafiklerin (kart, ana grafik, sosyal kutu ve sparkline grafikler) oluşturulmasını ve özelleştirilmesini sağlar.
  Geliştiricinin kolayca yeni grafikler eklemesine ve mevcut grafikleri özelleştirmesine yardımcı olacak örnek kodlar ve yardımcı fonksiyonlar içerir.
  Projede, istatistiksel verilerin ve raporların görsel olarak sunulması için kullanılır.
*/
