# Bu dosya, öğrencilerle (student) ilgili veritabanı tablolarını (modelleri) tanımlar.
# Sınıf, şube, vardiya, öğrenci bilgileri ve yoklama (attendance) işlemlerini veritabanında saklamak ve yönetmek için kullanılır.
# Ayrıca, yoklama işlemleri için özel bir yönetici (AttendanceManager) içerir.
