# Bu dosya, öğrencilerle (student) ilgili view (görünüm) fonksiyonlarını tanımlar.
# Öğrenci listeleme, detay görüntüleme, kayıt, düzenleme, silme ve yoklama sayımı işlemlerinin iş mantığını içerir.
# İlgili verileri alıp şablonlara aktarır ve kullanıcı işlemlerini yönetir.
