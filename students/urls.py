# Bu dosya, öğrencilerle (student) ilgili URL yönlendirmelerini tanımlar.
# Öğrenci listeleme, detay görüntüleme, kayıt, düzenleme, silme ve yoklama sayımı işlemlerine ait view fonksiyonlarına erişim yolları burada belirlenir.
