# Bu dosya, çalışan (employee) ile ilgili veritabanı tablolarını (modelleri) tanımlamak için kullanılır.
# EmployeeInfo, OfficialInfo ve PersonalInfo modelleri; çalışanların resmi, kişisel ve genel bilgilerini veritabanında saklamak amacıyla oluşturulmuştur.
